class TranscriptUploader < Shrine
  ...
  # WEBVTT header, and only contain well-formed, bounded cue timings. Mime type
  # and extension are derived from client-supplied metadata, so this check is
  # the actual guard against content spoofing.
